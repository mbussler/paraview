/*=========================================================================
  ...
  Module:    vtkStrainRateTensorGlyph.h
...
=========================================================================*/
// .NAME vtkStrainRateTensorGlyph - scale and orient glyph(s) according to tensor eigenvalues and eigenvectors
// .SECTION Description
// vtkStrainRateTensorGlyph is a filter that copies a geometric representation
...
#ifndef __vtkStrainRateTensorGlyph_h
#define __vtkStrainRateTensorGlyph_h

#include "vtkFiltersCoreModule.h" // For export macro
#include "vtkPolyDataAlgorithm.h"

class vtkStrainRateTensorGlyph : public vtkPolyDataAlgorithm
{
public:
  vtkTypeMacro(vtkStrainRateTensorGlyph,vtkPolyDataAlgorithm);
  ...
  static vtkStrainRateTensorGlyph *New();
...
private:
  vtkStrainRateTensorGlyph(const vtkStrainRateTensorGlyph&);  // Not implemented.
  void operator=(const vtkStrainRateTensorGlyph&);  // Not implemented.
};

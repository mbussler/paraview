/*=========================================================================
  ...
  Module:    vtkStrainRateTensorGlyph.cxx
...
=========================================================================*/
#include "vtkStrainRateTensorGlyph.h"
...
vtkStandardNewMacro(vtkStrainRateTensorGlyph);

// Construct object with scaling on and scale factor 1.0. Eigenvalues are
// extracted, glyphs are colored with input scalar data, and logarithmic
// scaling is turned off.
vtkStrainRateTensorGlyph::vtkStrainRateTensorGlyph()
{
  this->Scaling = 1;
...
//----------------------------------------------------------------------------
int vtkStrainRateTensorGlyph::RequestUpdateExtent(
...
//----------------------------------------------------------------------------
int vtkStrainRateTensorGlyph::RequestData(
  vtkInformation *vtkNotUsed(request),
  vtkInformationVector **inputVector,
  vtkInformationVector *outputVector)
{
  ...
  for (inPtId=0; inPtId < numPts; inPtId++)
    ...
    if ( true ) //this->ExtractEigenvalues ) // extract appropriate eigenfunctions
      {
    ...
    for (dir=0; dir < numDirs; dir++)
      ...
      // old behaviour of vtkStrainRateTensorGlyphs (which only used one dir),
...
//----------------------------------------------------------------------------
void vtkStrainRateTensorGlyph::SetSourceConnection(int id, vtkAlgorithmOutput* algOutput)
{
  if (id < 0)
    {
...
//----------------------------------------------------------------------------
void vtkStrainRateTensorGlyph::SetSourceData(vtkPolyData *source)
{
  this->SetInputData(1, source);
}

//----------------------------------------------------------------------------
vtkPolyData *vtkStrainRateTensorGlyph::GetSource()
{
...
//----------------------------------------------------------------------------
int vtkStrainRateTensorGlyph::FillInputPortInformation(int port, vtkInformation *info)
{
  if (port == 1)
    {
...
//----------------------------------------------------------------------------
void vtkStrainRateTensorGlyph::PrintSelf(ostream& os, vtkIndent indent)
{

/*=========================================================================
  ...
  Module:    vtkTensorGlyphNormalized.h
...
=========================================================================*/
// .NAME vtkTensorGlyphNormalized - scale and orient glyph(s) according to tensor eigenvalues and eigenvectors
// .SECTION Description
// vtkTensorGlyphNormalized is a filter that copies a geometric representation
...
#ifndef __vtkTensorGlyphNormalized_h
#define __vtkTensorGlyphNormalized_h

#include "vtkPolyDataAlgorithm.h"

class vtkTensorGlyphNormalized : public vtkPolyDataAlgorithm
{
public:
  vtkTypeMacro(vtkTensorGlyphNormalized,vtkPolyDataAlgorithm);
  ...
  static vtkTensorGlyphNormalized *New();
...
private:
  vtkTensorGlyphNormalized(const vtkTensorGlyphNormalized&);  // Not implemented.
  void operator=(const vtkTensorGlyphNormalized&);  // Not implemented.
};

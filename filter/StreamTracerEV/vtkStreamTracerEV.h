...
=========================================================================*/
// .NAME vtkStreamTracerEV - Streamline generator
// .SECTION Description
// vtkStreamTracerEV is a filter that integrates a vector field to generate
// streamlines. The integration is performed using a specified integrator,
// by default Runge-Kutta2.
//
// vtkStreamTracerEV produces polylines as the output, with each cell (i.e.,
...
//
// vtkStreamTracerEV supports forward (the default), backward, and combined
...
//
// vtkStreamTracerEV supports integration through any type of dataset. Thus if
...
#ifndef __vtkStreamTracerEV_h
#define __vtkStreamTracerEV_h
...
class vtkStreamTracerEV : public vtkPolyDataAlgorithm
{
public:
  vtkTypeMacro(vtkStreamTracerEV,vtkPolyDataAlgorithm);
...
//ETX
  ...
  // Description
  vtkSetMacro(UseCellVectors, bool);
  vtkGetMacro(UseCellVectors, bool);
...
private:
  vtkStreamTracerEV(const vtkStreamTracerEV&);  // Not implemented.
  void operator=(const vtkStreamTracerEV&);  // Not implemented.
};

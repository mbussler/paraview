...
=========================================================================*/
// .NAME vtkStreamTracerPCA - Streamline generator
// .SECTION Description
// vtkStreamTracerPCA is a filter that integrates a vector field to generate
// streamlines. The integration is performed using a specified integrator,
// by default Runge-Kutta2.
//
// vtkStreamTracerPCA produces polylines as the output, with each cell (i.e.,
...
//
// vtkStreamTracerPCA supports forward (the default), backward, and combined
...
//
// vtkStreamTracerPCA supports integration through any type of dataset. Thus if
...
#ifndef __vtkStreamTracerPCA_h
#define __vtkStreamTracerPCA_h
...
class VTKFILTERSFLOWPATHS_EXPORT vtkStreamTracerPCA : public vtkPolyDataAlgorithm
{
public:
  vtkTypeMacro(vtkStreamTracerPCA,vtkPolyDataAlgorithm);
...
private:
  vtkStreamTracerPCA(const vtkStreamTracerPCA&);  // Not implemented.
  void operator=(const vtkStreamTracerPCA&);  // Not implemented.
};

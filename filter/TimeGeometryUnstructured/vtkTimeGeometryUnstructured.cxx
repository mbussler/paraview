...
#include "vtkTimeGeometryUnstructured.h"
...
vtkStandardNewMacro(vtkTimeGeometryUnstructured);

vtkTimeGeometryUnstructured::vtkTimeGeometryUnstructured()
{
    growMesh = NULL;
    currentTime = 0;
}
...
int vtkTimeGeometryUnstructured::RequestData(vtkInformation *request,
                                       ...
                                       vtkInformationVector *outputVector)
{
    ...
    {
        growMesh = vtkSmartPointer<vtkUnstructuredGrid>::New();

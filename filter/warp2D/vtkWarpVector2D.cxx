...
vtkStandardNewMacro(vtkWarpVector2D);

//----------------------------------------------------------------------------
vtkWarpVector2D::vtkWarpVector2D()
{
...
//----------------------------------------------------------------------------
int vtkWarpVector2D::FillInputPortInformation(int vtkNotUsed(port),
                                            vtkInformation *info)
{
...
//----------------------------------------------------------------------------
int vtkWarpVector2D::RequestDataObject(vtkInformation *request,
...
void vtkWarpVector2DExecute2(vtkWarpVector2D *self,
...
void vtkWarpVector2DExecute(vtkWarpVector2D *self,
                          InputIterator begin,
                          InputIterator end,
                          OutputType *outPts,
                          vtkDataArray *vectors)
{
  ...
  switch (vectors->GetDataType())
    ...
    vtkDataArrayIteratorMacro(vectors,
      vtkWarpVector2DExecute2(self, begin, end, outPts, vtkDABegin));
    default:
      break;
    }
}
...
//----------------------------------------------------------------------------
int vtkWarpVector2D::RequestData(
  ...
  vtkInformationVector *outputVector)
{
  ...
  switch (input->GetPoints()->GetDataType())
    ...
    vtkDataArrayIteratorMacro(input->GetPoints()->GetData(),
      vtkWarpVector2DExecute(this, vtkDABegin, vtkDAEnd,
...
//----------------------------------------------------------------------------
void vtkWarpVector2D::PrintSelf(ostream& os, vtkIndent indent)
{

...
#include "vtkConvertToPolydata.h"
...
vtkStandardNewMacro(vtkConvertToPolydata);

//==============================================================================
vtkConvertToPolydata::vtkConvertToPolydata()
{
}
//==============================================================================
vtkConvertToPolydata::~vtkConvertToPolydata()
...
//==============================================================================
int vtkConvertToPolydata::RequestData(
    ...
    vtkInformationVector *outputVector)
{
    ...
    for( vtkIdType cellId=0; cellId<numCells; cellId++) 
    {
        ...
        bool copyCellData = false;
        if( cell->GetCellType() == VTK_VERTEX )
        {
            newVerts->InsertNextCell(1);
            newVerts->InsertCellPoint(cell->GetPointId(0));
            copyCellData = true;
        }
...
//----------------------------------------------------------------------------
int vtkConvertToPolydata::FillInputPortInformation(int, vtkInformation *info)
{
...
//==============================================================================
void vtkConvertToPolydata::PrintSelf(ostream &os, vtkIndent indent)
{

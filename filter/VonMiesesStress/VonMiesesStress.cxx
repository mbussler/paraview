...
vtkStandardNewMacro(VonMiesesStress);

//==============================================================================
VonMiesesStress::VonMiesesStress()
{
...
//==============================================================================
int VonMiesesStress::RequestData(
  ...
  vtkInformationVector *outputVector)
{
  ...
  vtkDebugMacro(<<"Calculating VonMieses Stress");
  ...
  vtkSmartPointer<vtkDoubleArray> normArray = vtkDoubleArray::New();
  normArray->SetName("VonMiesesStress");
  ...
  vtkDebugMacro(<<"Calculated " << numPts <<" von Mieses stress values");
...
//==============================================================================
void VonMiesesStress::PrintSelf(ostream &os, vtkIndent indent)
{
